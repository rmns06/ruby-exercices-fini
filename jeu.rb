class Personne
    ...
    def attaque(personne)
      ...
      if personne.points_de_vie <= 0
        puts " #{personne.nom} est déja mort !"
      else
  ...
  class Monde
    ...
    def ennemis_en_vie
      # A faire:
      # - Ne retourner que les ennemis en vie: création d'un tableau et le remplir par les ennemis appelé
      encore_en_vie = []
  ...
  100.times do |tour|
    ...
    if monde.ennemis_en_vie.size > 0
    # Si encore des ennemis ...
